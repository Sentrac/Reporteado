	...
	<div class="col-lg-12">
		<div class="card card-outline-inverse">
		  <div class="card-header">
		    <h4 class="m-b-0 text-white">Registrar Cliente</h4>
		  </div>
		  <div class="card-body">
			@if (count($errors) > 0)
		    ...
		    <form method="POST" action="{{ route('clientes.store') }}" class="form-horizontal form-bordered" role="form">
		    @csrf
		      <div class="form-body">
		        ...
		        <div class="form-group row">
		          ...
		          <div class="col-md-9">
		            <input type="text" placeholder="Alias" class="form-control" id="alias" name="alias">
		            <small class="form-control-feedback"> </small>
		          </div>
		        </div>
		        <div class="form-group row">
		          ...
		          <div class="col-md-9">
		            <input type="text" placeholder="RFC" class="form-control" id="rfc" name="rfc">
		        ...
		        <div class="form-group row">
		          ...
		          <div class="col-md-9">
		            <textarea rows="5" placeholder="Descripción" class="form-control" id="descripcion" name="descripcion"></textarea>
		            <small class="form-control-feedback"> </small>
		          </div>
		        </div>
