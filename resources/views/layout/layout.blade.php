            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li><a class="waves-effect waves-dark" href="{{route('clientes.index')}}"><i class="mdi mdi-home"></i><span class="hide-menu">Inicio</span></a></li>
                        <li><a class="waves-effect waves-dark" href="{{route('clientes.index')}}"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Usuarios</span></a></li>
                        <li><a class="waves-effect waves-dark" href="{{route('clientes.index')}}"><i class="mdi mdi-laptop"></i><span class="hide-menu">Clientes</span></a></li>
